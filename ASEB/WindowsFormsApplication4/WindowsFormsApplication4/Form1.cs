...
namespace WindowsFormsApplication4
{
    public partial class Form1 : Form
    {
        ...
        {
            {
                string filePath = @"C:\Users\Me\Desktop\ASEB\Data\09072501.hrm"; // agadi @ lagayo vane pachi single \ halle pugcha. if @ halena vane double \\ halna parcha
            ...
            public void processFile(string filePath)
            {
                ...
                {
                    txtDisplay.Text = "Exception Raised";
                }
            }
        }
}
